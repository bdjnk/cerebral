...
Before we begin you can have a look at [the solution over here](https://www.webpackbin.com/bins/-KfHaAcc0vCUyguD62hf). Click the **download** button, which downloads the project as a Webpack project, extract the contents to a folder on your computer and make sure that you have installed [Node JS](https://nodejs.org/en/). From the command line, run:
